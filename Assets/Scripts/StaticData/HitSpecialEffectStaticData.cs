...
{
	[CreateAssetMenu(fileName = "Hit Special Effect Static Data", menuName = "Scriptable Object/Static Data/Special Effect/Hit")]
	public class HitSpecialEffectStaticData : ScriptableObject
	{
