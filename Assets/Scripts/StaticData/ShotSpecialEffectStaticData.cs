...
{
	[CreateAssetMenu(fileName = "Shot Special Effect Static Data", menuName = "Scriptable Object/Static Data/Special Effect/Shot")]
	public class ShotSpecialEffectStaticData : ScriptableObject
	{
